...
#SBATCH -o out2UpsGaus.txt
#SBATCH -e err2UpsGaus.txt
...
python transfer_learn_net.py model=ft_transformer_pretrain_up2_gaussian hyp=hyp_pretrain_up3_gaussian dataset=ic_upstream2_Imputation_Gaussian_exp_100_1
