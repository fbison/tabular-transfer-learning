...
#SBATCH -o out2DsMean.txt
#SBATCH -e err2DsMean.txt
...
python transfer_learn_net_from_upstream.py preTrained=optuning-ft_transformer-ic_upstream2_Imputation_Mean_exp_100_1
