...
#SBATCH -o out3DsMean.txt
#SBATCH -e err3DsMean.txt
...
python transfer_learn_net_from_upstream.py preTrained=optuning-ft_transformer-ic_upstream3_Imputation_Mean_exp_100_1
