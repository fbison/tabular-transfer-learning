...
#SBATCH -o out3UpsMean.txt
#SBATCH -e err3UpsMean.txt
...
python transfer_learn_net.py model=ft_transformer_pretrain_up3_mean hyp=hyp_pretrain_up3_mean dataset=ic_upstream3_Imputation_Mean_exp_100_1
