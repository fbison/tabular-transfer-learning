...
#SBATCH -o out2DsGaus.txt
#SBATCH -e err2DsGaus.txt
...
python transfer_learn_net_from_upstream.py preTrained=optuning-ft_transformer-ic_upstream2_Imputation_Gaussian_exp_100_1
