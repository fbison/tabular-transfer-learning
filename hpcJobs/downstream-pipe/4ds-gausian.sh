...
#SBATCH -o out4DsGaus.txt
#SBATCH -e err4DsGaus.txt
...
python transfer_learn_net_from_upstream.py preTrained=optuning-mlp-ic_upstream4_Imputation_Gaussian_exp_100_1
