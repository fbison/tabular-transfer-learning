...
#SBATCH -o out4DsMean.txt
#SBATCH -e err4DsMean.txt
...
python transfer_learn_net_from_upstream.py preTrained=optuning-ft_transformer-ic_upstream4_Imputation_Mean_exp_100_1
