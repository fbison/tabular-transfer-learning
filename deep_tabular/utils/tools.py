...
from .ic_tools import get_ic_dataset, get_synthetic_dataset, get_cep_dataset
...
def get_dataloaders(cfg, which_dataset=None):
    ...
    if cfg_dataset.task == 'multilabel':
    ...
    elif cfg_dataset.name.split('_')[0] == 'ic':
        ...
        x_numerical, x_categorical, y, info, full_cat_data_for_encoder = get_cep_dataset(dataset_name=cfg_dataset.name,
                                                                                  task=cfg_dataset.task,
                                                                                  stage=cfg_dataset.stage)
    else:
