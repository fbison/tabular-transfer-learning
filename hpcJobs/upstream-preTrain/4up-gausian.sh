...
#SBATCH -o out4UpsGaus.txt
#SBATCH -e err4UpsGaus.txt
...
python transfer_learn_net.py model=ft_transformer_pretrain_up4_gaussian hyp=hyp_pretrain_up4_gaussian dataset=ic_upstream4_Imputation_Gaussian_exp_100_1
