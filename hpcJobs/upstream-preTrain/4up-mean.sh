...
#SBATCH -o out4UpsMean.txt
#SBATCH -e err4UpsMean.txt
...
python transfer_learn_net.py model=ft_transformer_pretrain_up4_mean hyp=hyp_pretrain_up4_mean dataset=ic_upstream4_Imputation_Mean_exp_100_1
